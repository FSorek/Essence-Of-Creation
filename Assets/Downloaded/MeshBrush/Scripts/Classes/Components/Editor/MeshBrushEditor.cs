...
namespace MeshBrush
{
    ...
    public class MeshBrushEditor : Editor
    {
        ...
        SerializedProperty randomRotationRange;
        ...
        void GatherSerializedProperties()
        {
            ...
            randomRotationRange = serializedObject.FindProperty("randomRotationRange");
        ...
        {
            if (globalPaintingMode.boolValue)
            {
        ...
        void TemplatesInspector()
        {
            ...
            if (templatesFoldout.boolValue)
            {
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    GUILayout.BeginVertical("Box", GUILayout.MaxHeight(56.5f));
                    {
        ...
        void RandomizersInspector()
        {
            ...
            if (randomizersFoldout.boolValue)
            {
                ...
                DrawMinMaxSlider(randomRotationRange, 0f, 100f, 2);
        ...
        void OnSceneGUI()
        {
            ...
            if (active.boolValue)
            {
                ...
                {
                    radius.floatValue += 0.35f * Time.deltaTime;
                ...
                if (globalPaintingMode.boolValue ? Physics.Raycast(ray, out hit, Mathf.Infinity, globalPaintLayerMask) : meshBrush.CachedCollider.Raycast(ray, out hit, Mathf.Infinity))
                {
                    ...
                    switch (currentEvent.type)
                    {
                        ...
                        case EventType.MouseDrag:
                            ...
                            if (meshBrush.paintKey == KeyCode.Mouse0 && currentEvent.button == 0)
                                meshBrush.PaintMeshes(hit);
                            else if (meshBrush.deleteKey == KeyCode.Mouse0 && currentEvent.button == 0)
            ...
            if (Selection.gameObjects.Length == 1 && Selection.activeGameObject.transform == meshBrush.CachedTransform)
            {
                ...
                switch (_phase)
                {
                    ...
                    case 1:
                        ...
                        if (previewObj != null)
                        {
                            previewObj.transform.localScale = Vector3.one * (lastMousePos - currentEvent.mousePosition).magnitude * 0.01f;
